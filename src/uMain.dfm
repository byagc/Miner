object frmMain: TfrmMain
  ...
  object PanelMain: TPanel
    ...
    object PanelMainContainer: TPanel
      Left = 166
      Top = 30
      Width = 890
      Height = 489
    ...
    object PanelMainLeft: TPanel
      ...
      object TreeView1: TTreeView
        ...
        Items.NodeData = {
          ...
          
          000000010756006F0078004100700070007300}
      end
    end
    object PanelMainTop: TPanel
      ...
      object Tabs: TChromeTabs
        ...
        Width = 1012
        Height = 29
        OnActiveTabChanging = TabsActiveTabChanging
  ...
  object PopupMenu1: TPopupMenu
    ...
    object miShowLeftPainel: TMenuItem
      Action = actShowLeftPainel
    end
  ...
  object ActionManager1: TActionManager
    ...
    object actNewBrowser: TAction
      Category = 'File'
      Caption = 'Browser'
      Hint = 'Nova aba edi'#231#227'o texto'
      ImageIndex = 38
      ShortCut = 16468
      OnExecute = actNewBrowserExecute
    end
    ...
    object actNewEditor: TAction
      Category = 'File'
      Caption = 'Notepad'
      Hint = 'Nova aba edi'#231#227'o texto'
      ImageIndex = 49
      ShortCut = 16453
      OnExecute = actNewEditorExecute
    end
    object actShowLeftPainel: TAction
      Category = 'View'
      Caption = 'Painel'
      ImageIndex = 81
      OnExecute = actShowLeftPainelExecute
    end
  end
